...
public class BaseDataObject implements Serializable, Cloneable, Remote, IBaseDataObject {
     ...
     */
    public static class KryoDeserialzerIterator implements Iterator<List<IBaseDataObject>>, AutoCloseable {
        ...
        public KryoDeserialzerIterator(InputStream src) {
            this.src = src;
        ...
        public KryoDeserialzerIterator(Path path) throws IOException {
