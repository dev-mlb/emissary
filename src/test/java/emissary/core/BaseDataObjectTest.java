...
public class BaseDataObjectTest extends UnitTest {
    ...
    public void testDeserializerIterator() {
        ...
        ByteArrayInputStream in = new ByteArrayInputStream(baos.toByteArray());
        BaseDataObject.KryoDeserialzerIterator it = new BaseDataObject.KryoDeserialzerIterator(in);
    ...
    public void testException() {
        ...
        ByteArrayInputStream in = new ByteArrayInputStream(baos.toByteArray());
        BaseDataObject.KryoDeserialzerIterator it = Mockito.spy(new BaseDataObject.KryoDeserialzerIterator(in));
